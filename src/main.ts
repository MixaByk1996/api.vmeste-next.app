...
async function bootstrap() {
  ...
  https.get(
      ...
      (response) {
        response.pipe(createWriteStream(process.cwd()+'/swagger-static/swagger-ui-bundle.js'));
        console.log(
  ...
  https.get(`${serverUrl}/swagger/swagger-ui-init.js`, function (response) {
    response.pipe(createWriteStream(process.cwd()+'/swagger-static/swagger-ui-init.js'));
    console.log(
  ...
  https.get(
      ...
      function (response) {
        response.pipe(
            createWriteStream(process.cwd()+'/swagger-static/swagger-ui-standalone-preset.js'),
        );
        console.log(
  ...
  https.get(`${serverUrl}/swagger/swagger-ui.css`, function (response) {
    response.pipe(createWriteStream(process.cwd()+'/swagger-static/swagger-ui.css'));
    console.log(
