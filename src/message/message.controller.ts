...
export class MessageController {
  ...
  @ApiResponse({
    status: 200,
    description: 'return: Заявка со сообщениями в ней',
  })
  ...
  @ApiBody({
    description: 'Создание сообщения с опросом в чате',
    type: CreateQuizMessageDto,
  })
  ...
  @ApiBody({
    description: 'Создание обычного текстового сообщения',
    type: CreateTextMessageDto,
  })
  async createMessage(
